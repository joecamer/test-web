...
var render = function() {
  ...
  return _c("layout", [
    _c("div", { staticClass: "p-3" }, [
      _c("h3", [_vm._v("On a recu : " + _vm._s(_vm.foo))])
    ])
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("div", [
    _c(
      "div",
      { staticClass: "container-fluid bg-light vh-100 position-relative" },
      [
        _c(
          "div",
          {
            staticClass: "row h-100 flex-wrap-reverse flex-md-wrap main-frame"
          },
          [
            _c(
              "div",
              {
                staticClass:
                  "col-lg-2 col-md-3 d-md-flex d-none p-0 bg-primary text-white flex-column justify-content-between h-100"
              },
              [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "col h-100 bg-white" })
          ]
        ),
        _vm._v(" "),
